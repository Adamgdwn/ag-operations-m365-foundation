...
3. Use the Stage 8D walkthrough guide to test one internal dummy path.
4. Fill the walkthrough capture template and findings register with any confusion points before creating Teams tabs or more automation.
