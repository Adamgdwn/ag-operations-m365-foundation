...
- Generated: 2026-06-25T18:20:51.2876313-06:00
...
- SignalStatus: New
- IntentPath: My team — I want to build team capability

Checks:
- PASS: IntakeSource (expected Guided AI Journey; actual Guided AI Journey)
- PASS: SignalType (expected Website; actual Website)
- PASS: SignalStatus (expected New; actual New)
- PASS: Priority (expected Normal; actual Normal)
- PASS: Marker (expected GAIL-INTERNAL-WALKTHROUGH-B6-JOURNEY; actual found)
- PASS: NeedSummary (expected not blank; actual present)

Read-only triage command:

```powershell
.\scripts\Invoke-M365NewSignalTriage.ps1 -ItemId 21 -NoPause
```
