...
# Opens a visible PowerShell window for the Stage 8 homepage refinement builder.
...
$targetScript = Join-Path $scriptRoot "Invoke-M365Stage8HomepageRefinementBuild.ps1"
...
Write-Host "Opening visible PowerShell window for Stage 8 homepage refinement..." -ForegroundColor Cyan
...
Start-VisiblePowerShellConsole -Title "M365 Stage 8 Homepage Refinement" -PowerShellPath $powerShellHost.Source -Arguments $arguments -WorkingDirectory $workspaceRoot
