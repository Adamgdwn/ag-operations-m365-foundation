...
# Opens a visible PowerShell window for the SharePoint CRM apply.
...
$targetScript = Join-Path $scriptRoot "Apply-CrmSharePoint.ps1"
...
Write-Host "Opening visible PowerShell window for the SharePoint CRM apply..." -ForegroundColor Cyan
...
Start-VisiblePowerShellConsole -Title "M365 CRM SharePoint Apply" -PowerShellPath $powerShellHost.Source -Arguments $arguments -WorkingDirectory $workspaceRoot
