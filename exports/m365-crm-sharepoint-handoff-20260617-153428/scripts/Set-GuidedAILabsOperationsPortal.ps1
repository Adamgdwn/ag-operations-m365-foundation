...
<td style="width:25%;vertical-align:top;padding:8px;">
  <div style="border:1px solid #d0d7de;border-top:5px solid $Accent;border-radius:8px;padding:14px;min-height:210px;background:#ffffff;">
    <h3 style="margin:0 0 6px 0;font-size:20px;"><a href="$(ConvertTo-HtmlText $Href)" style="color:#0f172a;text-decoration:underline;text-decoration-thickness:1px;text-underline-offset:3px;">$(ConvertTo-HtmlText $Title)</a></h3>
