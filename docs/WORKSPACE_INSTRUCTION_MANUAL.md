...
- New Signal, Journey receipt, Journey replay/idempotency, B9b selected
  ...
  that order. B10b QUO implementation-ready placeholder/design, B10c.0 local
  key readiness, and B10c.0a QUO/Sona prompt placement are complete; live QUO
  proof is B10c.1/later and still needs exact source-proof approval. No
